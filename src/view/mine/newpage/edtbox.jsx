...
export default class Edtbox extends React.Component{
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        this.microApp = loadMicroApp({
            name: this.props.micorkey+'edt',
            entry: `/public/micor/${this.props.micorkey}/edt/index.html`,
            container: this.rootRef.current,
            props: { data: this.props.data, index: this.props.index, updateData: this.props.updateData },
        });
    }
    componentDidUpdate(olddata) {
        if ((!olddata || !olddata.data || !this.props.data || !this.props.data.cpdata)
            && olddata.index === this.props.index) return;
        if (this.compare(olddata.data.cpdata, this.props.data.cpdata) && olddata.index === this.props.index) return;
